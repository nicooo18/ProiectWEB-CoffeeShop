document.addEventListener('DOMContentLoaded', () => {
  ...
  // Afișează toate review-urile + creează scroll infinit
  function displayReviews(reviews) {
    reviewsContainer.innerHTML = ''; // curăță tot
    ...
    // Adaugă clone pentru scroll infinit
  ...
  // Lista recenziilor curente (în memorie)
  const allReviews = [...initialReviews];

  // Inițial: afișează recenziile
  displayReviews(allReviews);

  // Când adaugi un review nou
  addReviewBtn.addEventListener('click', () => {
    ...
    // Adaugă în listă și reafișează totul
